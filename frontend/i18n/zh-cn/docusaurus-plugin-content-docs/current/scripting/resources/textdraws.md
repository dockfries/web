...
title: 文本绘制
sidebar_label: 文本绘制
description: 文本绘制是在玩家屏幕上绘制的文字元素，可长期显示动态内容
---

## 什么是文本绘制？

文本绘制（Textdraw）是在玩家屏幕上显示的文字元素。与[客户端消息](../functions/SendClientMessage)或[游戏文本](../functions/GameTextForPlayer)不同，文本绘制可以无限期显示。既支持简单静态文本（如网站地址），也可创建复杂的动态元素（如进度条）。
...
- [TextDrawCreate](../functions/TextDrawCreate): 创建文本绘制
- [TextDrawDestroy](../functions/TextDrawDestroy): 销毁文本绘制
...
- [TextDrawGetPreviewVehCol](../functions/TextDrawGetPreviewVehCol): 获取预览载具颜色配置
- [TextDrawGetPreviewVehicleColours](../functions/TextDrawGetPreviewVehicleColours): 获取预览载具完整配色方案
...
- [CreatePlayerTextDraw](../functions/CreatePlayerTextDraw): 创建玩家文本绘制
- [PlayerTextDrawDestroy](../functions/PlayerTextDrawDestroy): 销毁玩家文本绘制
...
- [PlayerTextDrawBackgroundColor](../functions/PlayerTextDrawBackgroundColor): 设置玩家文本绘制的背景颜色
- [PlayerTextDrawAlignment](../functions/PlayerTextDrawAlignment): 设置玩家文本绘制的对齐方式
- [PlayerTextDrawFont](../functions/PlayerTextDrawFont): 设置玩家文本绘制的字体样式
- [PlayerTextDrawLetterSize](../functions/PlayerTextDrawLetterSize): 设置玩家文本绘制的字符尺寸
...
- [PlayerTextDrawSetString](../functions/PlayerTextDrawSetString): 更新玩家文本绘制内容
- [PlayerTextDrawShow](../functions/PlayerTextDrawShow): 显示玩家文本绘制
- [PlayerTextDrawHide](../functions/PlayerTextDrawHide): 隐藏玩家文本绘制
- [IsPlayerTextDrawVisible](../functions/IsPlayerTextDrawVisible): 检测玩家文本绘制的可见状态
- [IsValidPlayerTextDraw](../functions/IsValidPlayerTextDraw): 验证玩家文本绘制的有效性
- [PlayerTextDrawBackgroundColour](../functions/PlayerTextDrawBackgroundColour): 调整玩家文本绘制的背景色彩（英式拼写）
...
- [PlayerTextDrawGetPreviewVehicleColours](../functions/PlayerTextDrawGetPreviewVehicleColours): 获取载具预览配色方案
...
- [PlayerTextDrawSetPreviewVehicleColours](../functions/PlayerTextDrawSetPreviewVehicleColours): 设置载具预览配色（需配合 3D 模型显示）
...
声明存储文本绘图 ID 的变量/数组后，即可开始创建。全局文本绘图应在 [OnGameModeInit](../callbacks/OnGameModeInit) 回调中创建，使用 [TextDrawCreate](../functions/TextDrawCreate) 函数。注意此函数仅创建对象，后续需其他函数进行修改和展示。
