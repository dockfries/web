...
| 宏定义                              | 数值                 | 步行嵌入代码 <sup>(6)</sup> | 载具嵌入代码 <sup>(6)</sup>   | 步行默认按键           | 载具默认按键            |
| ----------------------------------- | -------------------- | --------------------------- | ----------------------------- | ---------------------- | ----------------------- |
...
**(3)**​ GROUP_CONTROL_FWD 在 SA-MP 中用于乘客进入载具，无法直接检测，但其游戏文本定义仍存在

**(4)**​ 若键值 262144 无效，可使用键值 2 替代

**(5)**​ 仅在控制器设置为"JOYPAD"时生效

**(6)**​ 嵌入代码仅适用于[死亡信息](../functions/SendDeathMessage)、[文本绘制](../functions/TextDrawCreate)和[游戏文本](../functions/GameTextForPlayer)
