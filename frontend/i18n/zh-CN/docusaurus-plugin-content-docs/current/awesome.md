...
title: 推荐清单
sidebar_label: 推荐清单
description: 精心整理的实用工具、库、游戏模式、滤镜脚本和插件列表，用于SA-MP/open.mp开发。
---
...
- **[Plugin Runner](https://github.com/Y-Less/samp-plugin-runner)** - 直接从命令行运行轻量级服务器版本的工具（无需server.cfg），用于测试插件。
- **[samp-plugin-boilerplate](https://github.com/Southclaws/samp-plugin-boilerplate)** - 通过模板快速创建插件。
- **[SA:MP Plugin Template Library](https://github.com/katursis/samp-ptl)** - 使用此模板库快速轻松地创建自定义插件。
- **[Pawn Playground](https://pg.open.mp)** - 由 open.mp 官方提供的在线 Pawn 代码运行平台。
...
现在无需插件即可使用open.mp通过其他语言编写脚本，详见[此博客文章](https://www.open.mp/zh-CN/blog/release-candidate-1#sdk)
...
- **[ompgo](https://github.com/ompgo-dev/ompgo)** - Go语言支持（编写open.mp游戏模式/组件）
